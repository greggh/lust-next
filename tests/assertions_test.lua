-- Tests for the core assertions in lust-next
...
describe("Core Assertions", function()
  ...
  describe("Function Assertions", function()
    it("checks if a function fails", function()
      local function fails() error("error message") end
...
-- Return true to indicate test file executed successfully
return true