...
-- Load formatters
M.html = require("lib.coverage.v2.formatters.html")
M.lcov = require("lib.coverage.v2.formatters.lcov") 
M.json = require("lib.coverage.v2.formatters.json")
M.cobertura = require("lib.coverage.v2.formatters.cobertura")
